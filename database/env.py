...
from src.fastapi_reference.data.models import *
...
if database_settings.database_type.value == "sqlite":
    config.set_main_option("sqlalchemy.url", f"sqlite:///{database_settings.database_name}.db")
else:
